...
MODULE3_DIR = $(OBJ_BASE_DIR)/$(exec_module3)
...
src_module3 = hcaviar_module3.cpp hcaviar_main.cpp LDMatrix.cpp GWAS_Z_observed.cpp hCaviarModel.cpp Util.cpp

# 모듈 객체 파일 리스트
obj_module1 = $(addprefix $(MODULE1_DIR)/, $(src_module1:.cpp=.o))
obj_module2 = $(addprefix $(MODULE2_DIR)/, $(src_module2:.cpp=.o))
obj_module3 = $(addprefix $(MODULE3_DIR)/, $(src_module3:.cpp=.o))

# 모듈 타겟
exec_module1 = hcaviar_module1
exec_module2 = hcaviar_module2
exec_module3 = hCAVIAR_fwrite

# 디렉토리 생성 규칙
$(OBJ_DIR_RELEASE) $(OBJ_DIR_DEBUG) $(MODULE1_DIR) $(MODULE2_DIR) $(MODULE3_DIR):
	mkdir -p $@
...
# 모듈 3 빌드
$(exec_module3): $(MODULE3_DIR) $(obj_module3)
	$(CXX) $(CXXFLAGS) $(obj_module3) $(LDFLAGS) -o $@
...
# 정리
clean:
	rm -rf $(OBJ_BASE_DIR) $(TARGET) $(TARGET_DEBUG) $(exec_module1) $(exec_module2) $(exec_module3)
